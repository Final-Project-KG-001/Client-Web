  ...
  return (
    <div className='div-login container-fluid'>
      ...
      <form>
        ...
        <button style={ { backgroundColor: '#86c4ba', color: '#ffa34d ', outline: 'none', borderColor: '#86c4ba' } } type="submit" className="btn btn-primary" onClick={ () => handleClick() }>Login</button>
      </form>
    </div>
  )
}
